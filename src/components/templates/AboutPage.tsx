...
// Importing types
import { AboutDataType } from "src/Types";
...
const AboutPage = () => {
  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col mt-16 items-center xl:flex-row gap-x-6">
          ...
          >
            <div className="flex flex-1 xl:gap-x-6">
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
                ...
                <div className="text-x5 uppercase tracking-[1px] leading-[1.4] max-w-[100px]">
                  Years of Experience
                </div>
              </div>
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0">
        ...
        <motion.div
          ...
          animate="show"
          exit="hidden"
          className="flex flex-col xl:max-w-[48%] h-[480px]"
        >
